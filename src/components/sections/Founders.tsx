...
const FOUNDERS = [
  {
    ...
    title_color: "text-peacock-deep",
    name_color: "text-ink-strong",
  ...
  },
  {
    ...
    title_color: "text-turmeric-deep",
    name_color: "text-ink-strong",
...
export function Founders() {
  return (
    <section id="founders" className="relative paper py-28 sm:py-40">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-3">
          {FOUNDERS.map((founder, i) => (
            <Reveal key={founder.name} delay={i * 0.08}>
              <div className={`flex h-full flex-col rounded-2xl border-t-4 border-ink-strong/10 bg-white/70 p-8 shadow-sm ${founder.border}`}>
                <FounderMark
                ...
                <h3 className="mt-3 font-display text-2xl font-bold text-ink-strong">
                  {founder.name}
                </h3>
                <p className={`mt-2 text-xs uppercase tracking-[0.08em] ${founder.title_color}`}>
                  {founder.role}
                </p>
                <p className="mt-4 text-sm text-ink-soft">{founder.bio}</p>
                <p className={`mt-6 border-l-2 pl-4 font-display font-medium text-ink-strong ${founder.quote_border}`}>
        ...
        <Reveal delay={0.3}>
          <div className="mt-20 text-center">
            ...
            <p className="mt-6 font-display text-3xl font-extrabold text-gradient-deep sm:text-4xl">
              Three people. Three strengths. One mission.
            </p>
            <p className="mt-4 font-display text-2xl font-bold text-ink-strong sm:text-3xl">
