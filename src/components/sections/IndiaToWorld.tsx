  ...
  return (
    <section className="relative bg-charcoal-soft py-28 sm:py-40">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <Reveal delay={0.1}>
          <div className="mt-16 flex flex-wrap items-center justify-center gap-3 font-display text-lg text-ivory sm:text-2xl">
            ...
            <span>Scale</span>
            <span className="text-saffron">→</span>
            <span className="text-saffron-soft">Beyond India</span>
          </div>
        </Reveal>

        <Reveal delay={0.2}>
          <p className="mt-16 font-display text-2xl italic text-ivory sm:text-3xl text-balance">
