  ...
  return (
    <section className="relative paper-peacock py-28 sm:py-40">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <Reveal delay={0.1}>
          <div className="mt-16 flex flex-wrap items-center justify-center gap-3 font-display text-lg font-semibold text-ink-strong sm:text-2xl">
            ...
            <span className="text-gradient-deep">Beyond India</span>
          </div>
        </Reveal>

        <Reveal delay={0.2}>
          <p className="mt-16 font-display text-2xl font-bold text-ink-strong sm:text-3xl text-balance">
